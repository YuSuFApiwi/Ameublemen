...
function  addLingeForme(array) {
    ...
    for (let index = 0; index < array.length; index++) {
        $(".dimension").append(`<label class="col-xs-3 lead" for="forme_linge_`+array[index]+`">Linge «`+array[index]+`» : </label>
            <div class="col-xs-7">
            ...
            </div><span class="col-xs-2 lead">ML</span>`);
    }
}
...
  $.post("response.php",dataFrom,function(response){
